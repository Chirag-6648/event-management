...
const Contact = () => {
  return (
    <div
      className="min-h-screen bg-black text-white flex bg-cover items-center justify-center p-6"
      style={{ backgroundImage: `url(${mountain})` }}>
      <div className="w-full max-w-3xl bg-gray-950/70 rounded-2xl shadow-lg p-8">
